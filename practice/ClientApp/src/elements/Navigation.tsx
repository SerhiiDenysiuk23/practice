...
const Navigation = () => {
    const langList: Option[] = [
        {label: "RU", value: "RU"},
        {label: "UA", value: "UA"},
        {label: "EN", value: "EN"}
    ]
    const currencyList: Option[] = [
        {label: "UAH", value: "UAH"},
        {label: "USD", value: "USD"},
        {label: "EUR", value: "EUR"}
    ]
    ...
    const langSelectHandler = (option: Option) => {
        setLang(option.value)
    }
    const [currency, setCurrency] = useState<"RU" | "UA" | "EN">("RU")
    const currencySelectHandler = (option: Option) => {
    ...
    return (
        <nav className="nav-bar">
            ...
            <ul className="nav-bar_navigation">
                <li className={useLocation().pathname == "/new" ? "active-nav" : ""}><a href="">NEW</a></li>
                <li className={useLocation().pathname == "/catalog" ? "active-nav" : ""}><a href="/catalog">КАТАЛОГ</a></li>
                <li className={useLocation().pathname == "/aboutUs" ? "active-nav" : ""}><a href="">О НАС</a></li>
            </ul>
            <div className="logo">
                <a href="/">YANKI</a>
            </div>
            <ul className="dropdown">
                <li>
                   <Select selectHandler={langSelectHandler} options={langList}/>
                </li>
                <li>
                    <Select selectHandler={currencySelectHandler} options={currencyList}/>
                </li>
            </ul>
            <ul className="nav-icon">
                <li>
                    <svg className="nav-icon_elem icon-search" viewBox="0 0 25 25"
                ...
                <li>
                    <svg className="nav-icon_elem" viewBox="0 0 20 25" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <li>
                    <svg className="nav-icon_elem" viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <li>
                    <a href="/basket"><svg className="nav-icon_elem" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                        <path
